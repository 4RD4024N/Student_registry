...
public class ChatMessageService : IChatMessageService
{
    ...
    public async Task<ChatMessageDTO> SendMessageAsync(CreateChatMessageDTO messageDto)
    {
        ...
        return MapToDTO(await GetMessageByIdAsync(message.MessageId)
            ?? throw new InvalidOperationException("Message not found after creation"));
    }

    private ChatMessageDTO MapToDTO(ChatMessageDTO chatMessageDTO)
    {
